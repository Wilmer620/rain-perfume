...
.quiz-result{display:none;text-align:center}.quiz-result.active{display:block;animation:fUp .5s ease-out}
.quiz-result .qr-label{font-family:'Inter',sans-serif;font-size:.48rem;letter-spacing:.4em;color:var(--gold-d);text-transform:uppercase;margin-bottom:.5rem;opacity:.6}
.quiz-result .name{font-family:'Cormorant Garamond',serif;font-size:1.6rem;font-weight:400;letter-spacing:.1em;color:var(--ink);margin-bottom:.15rem}
...
.qr-divider{width:30px;height:1px;background:var(--gold-d);opacity:.25;margin:.8rem auto}
