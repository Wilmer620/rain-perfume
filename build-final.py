...
NARRATIVES = {
    ...
    'world': {
        ...
        'items': [
            ('Pulse', '脉搏', '<em>脉搏</em>——世界之色中代表<em>红</em>的那一支。它关于爱情，但不是甜蜜的、温暖的、包裹的——而是<em>跳动的</em>。Pulse 的粉红胡椒与藏红花前调像两颗心脏各自跳动时忽然听见了彼此的频率；土耳其玫瑰的中调不是浪漫——是<em>共振</em>，是两个独立的节拍偶然撞在一起之后再也分不开；琥珀的尾调把这种同步封存在最深的节点上。爱情不是找到完美的人——是找到那个让你的脉搏<em>多跳一拍</em>的人。'),
...
# =====================================================================
world_cards = '\n'.join([
    world_card('', 'Pulse', '01', 'Pulse', '脉搏', '粉红胡椒 · 藏红花 · 柑橘', '土耳其玫瑰 · 五月玫瑰 · 番红花', '麝香 · 琥珀 · 檀木'),
