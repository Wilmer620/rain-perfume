...
/* 入场涟漪 */
.entrance-ripple{position:absolute;top:50%;left:50%;width:0;height:0;border-radius:50%;border:1px solid rgba(184,148,62,.2);transform:translate(-50%,-50%);z-index:0;animation:rippleOut 2s .15s ease-out forwards}
.entrance-ripple:nth-child(2){animation-delay:.35s;border-color:rgba(184,148,62,.12)}
.entrance-ripple:nth-child(3){animation-delay:.55s;border-color:rgba(184,148,62,.07)}
@keyframes rippleOut{0%{width:0;height:0;opacity:.5}100%{width:420px;height:420px;opacity:0;border-width:0}}
...
<svg class="hero-rain-logo" viewBox="0 0 260 40" width="220" height="34">
<line x1="122" y1="6"  x2="122" y2="26" stroke="var(--ink)" stroke-width=".8" stroke-linecap="round"/>
<line x1="130" y1="4"  x2="130" y2="28" stroke="var(--ink)" stroke-width="1.0" stroke-linecap="round"/>
<line x1="138" y1="8"  x2="138" y2="24" stroke="var(--ink)" stroke-width=".6" stroke-linecap="round"/>
<circle cx="130" cy="3" r="1.0" fill="var(--gold-d)"/>
</svg>
