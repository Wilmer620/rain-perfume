...
/* 雨声涟漪提示 */
/* 音乐提示 */
.hero-hint{text-align:center;margin-top:1.2rem;opacity:0;transform:translateY(6px);transition:opacity .5s,transform .5s}
.hero-hint.show{opacity:1;transform:translateY(0)}
.hero-hint span{display:inline-block;font-family:'Noto Serif SC',serif;font-size:.6rem;font-weight:300;color:var(--gold-d);letter-spacing:.1em;animation:heroHintPulse 2s ease-in-out infinite}
@keyframes heroHintPulse{0%,100%{opacity:.5}50%{opacity:1}}
...
var seriesImgs=[
  [{n:'Blur',d:'雾散了一点点，就一点点。',c:'花非花·雾非雾',t:'驻足苦旅',i:cs},{n:'Knot',d:'被拉紧又被松开的，不只是绳。',c:'结',t:'驻足苦旅',i:cs},{n:'Flirt',d:'逆风而行的人，风里都是她的味道。',c:'风骚',t:'驻足苦旅',i:cs},{n:'Peak',d:'冷不是温度，是距离。',c:'摩登巅',t:'驻足苦旅',i:cs},{n:'Wall',d:'每一道墙都有一道缝，放光进来。',c:'围城',t:'驻足苦旅',i:cs},{n:'Leave',d:'诀别是下一次重逢的序章。',c:'再别',t:'驻足苦旅',i:cs},{n:'Iris',d:'瞳孔里装得下整个天空。',c:'瞳孔',t:'驻足苦旅',i:cs},{n:'Sun&Moon',d:'用最慢的火，熬白昼与黑夜。',c:'日月煎',t:'驻足苦旅',i:cs}],
  ...
  [{n:'Face',d:'脸埋进枕头之后剩下的自己。',c:'皮囊',t:'灵感盛宴',i:cs},{n:'Gone',d:'别人还在找你，你已经在别处了。',c:'隐身衣',t:'灵感盛宴',i:cs},{n:'Wait',d:'等待是一个决定——你决定了，你就在。',c:'等待',t:'灵感盛宴',i:cs},{n:'Bliss',d:'不讲道理的快乐，像夏天的太阳雨。',c:'欢愉',t:'灵感盛宴',i:cs},{n:'Stay',d:'杯底的最后一抹温度。',c:'侍者',t:'灵感盛宴',i:cs},{n:'Decree',d:'在喧嚣中第一个做出决定的人。',c:'号令',t:'灵感盛宴',i:cs}],
  [{n:'Flash',d:'比心跳短，比闪电快。',c:'瞬息',t:'宙宇寰星',i:cs},{n:'Present',d:'推开一扇窗，让此刻进来。',c:'此刻',t:'宙宇寰星',i:cs},{n:'Bygone',d:'承认那个人来过，然后在安静中继续。',c:'彼时',t:'宙宇寰星',i:cs},{n:'Lightyear',d:'你不是宇宙的中心，你是目击者。',c:'光年',t:'宙宇寰星',i:cs},{n:'Origin',d:'最初的火花——在所有光出现之前。',c:'起源',t:'宙宇寰星',i:cs}],
  [{n:'Spring',d:'种子裂开，第一口氧气。',c:'春之生',t:'四季所生',i:cs},{n:'Summer',d:'热烈本身。不降温，不解释。',c:'夏之长',t:'四季所生',i:cs},{n:'Autumn',d:'把声音调低，听见血液流动。',c:'秋之收',t:'四季所生',i:cs},{n:'Winter',d:'冻土下的种子，等待也是生长。',c:'冬之藏',t:'四季所生',i:cs}],
  [{n:'Fall',d:'坠落也是飞翔的一种。',c:'自天穹',t:'雨后',i:cs},{n:'Drift',d:'不急着落地，再飘一会儿。',c:'穿云间',t:'雨后',i:cs},{n:'Shatter',d:'碎成更多的自己，渗入明天的土壤。',c:'碎地霜',t:'雨后',i:cs}]
];
...
btn.addEventListener('click',function(e){
  ...
  if(playing){
    ...
    master.gain.linearRampToValueAtTime(0.14,ctx.currentTime+0.4);
