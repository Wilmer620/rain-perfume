...
def narrative_btn(pid, suffix=''):
    ...
    for item in data.get('items', []):
        if len(item) == 4:
            ...
            subtitle = f'<span style="color:var(--ink3)">{cn_name}</span>  <span style="color:var(--gold);font-weight:400;letter-spacing:.06em">{en_name}</span>'
...
<p class="text"><em>3月12日 · 毛毛雨</em><br>今天的雨很小，小到你几乎不确定它是不是雨。我在窗边站了很久，伸出手试探了三次才确认——有东西落在掌心。这种雨不会打湿头发，但会在睫毛上停留很久。<br><br>这让我想起<em>驻足苦旅</em>——那些走在路上却不急于抵达的人。<em>花非花·雾非雾</em>不是答案，是学会在不确定中安静下来；<em>瞳孔</em>不是看，是注视；<em>再别</em>不是告别，是下次重逢的序章。有些香气就像毛毛雨——不需要被人认出，只需要<em>一直存在</em>。<br><br><em>6月8日 · 雷阵雨</em><br>下午三点，天突然黑了。雨来得毫无预兆，砸在玻璃上像一千颗小石子同时落下。整个城市都躲进了屋檐，但总有一些人不走——不是因为勇敢，是因为<em>有地方要去</em>。<br><br>这是<em>灵感盛宴</em>的节奏——不请自来，来了就占领一切。<em>欢愉</em>的笑声没有预警；<em>隐身衣</em>的退场不需要解释；<em>皮囊</em>的每一张脸都不是伪装，是不同时刻的真实自己。有些雨不是为了柔软——它是为了<em>冲刷</em>。它会淋透你，但你走出来的时候，比进去之前更清醒。<br><br><em>9月21日 · 雨后初晴</em><br>雨停之后的第十分钟。空气从没有这么干净过。每一片叶子都在滴水，每一个水洼都倒映着一小块天空。我蹲下来看一个水洼——里面有一朵很小的云。<br><br>这是<em>雨后</em>系列要捕捉的瞬间。<em>自天穹</em>从云层坠落，落在某片叶子上——轻到没人注意；<em>穿云间</em>选择慢慢来，在云层之间再飘一会儿；<em>碎地霜</em>触地碎裂后渗入泥土，成为明天某颗种子的一部分。还有<em>致新生</em>——它不是写给过去的告别信，是写给未来的<em>第一句话</em>。我开始明白 RAIN 要做的事：<em>不制造香水，只收集雨停之后那一分钟的安静。</em></p>
