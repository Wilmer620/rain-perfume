...
NARRATIVES = {
    'sojourn': {
        ...
        'items': [
            ...
            ('Sun&Moon', '日月煎', '日出和月升不能同时发生——但它们共用<em>同一片天空</em>。Sun&Moon 的当归与苦橙叶前调像凌晨四点——夜还没走，天已经开始发白；没药与沉香的中调是白天和黑夜的<em>交接仪式</em>；安息香的尾调把这两种相反的力量<em>煎熬成一味</em>——它有太阳的烈，也有月亮的凉。'),
        ]
    },
    'world': {
...
/* Quiz */
var qs=document.querySelectorAll(".quiz-step"),qr=document.getElementById("quizResult"),qrn=document.getElementById("qrName"),qrc=document.getElementById("qrCn"),qrd=document.getElementById("qrDesc"),qrx=document.getElementById("quizReset"),seriesScores=new Array(5).fill(0),productScores=[new Array(7).fill(0),new Array(6).fill(0),new Array(5).fill(0),new Array(4).fill(0),new Array(3).fill(0)],series=[{en:"Sojourn",cn:"驻足苦旅"},{en:"World",cn:"世界之色"},{en:"Feast",cn:"灵感盛宴"},{en:"Seasons",cn:"四季所生"},{en:"After",cn:"雨后"}],products=[[{en:"Blur",cn:"花非花·雾非雾",d:"像一场淡去的梦——你是那个学会在不确定中安静下来的人。你的雨是窗玻璃上的水汽，什么也不证明，只是在那里。"},{en:"Knot",cn:"结",d:"你深知有些痕迹永远不会消失——你活成了一个被解开却仍有形状的结。你的雨像被拉紧又松开的皮革绳，尖锐过，也柔软过。"},{en:"Flirt",cn:"风骚",d:"你故意逆风而行，风里却留下你的味道。你的雨是转身之后还停留在空气里的那一点什么——说不清楚，但谁都记得。"},{en:"Peak",cn:"摩登巅",d:"你站在高处，冷不是温度，是距离。你的雨是高楼间隙里透出的一丝柔软——冰冷却不绝望。"},{en:"Wall",cn:"围城",d:"你有一道看不见的墙——它让某些东西出不去，也放第一缕光进来。你的雨是老教堂的香火燃尽后，墙缝里的光。"},{en:"Leave",cn:"再别",d:"你从来不是结束——你是下一次重逢的序章。你的雨是铁轨延伸到很远很远之后，空气里最后的震动。"},{en:"Iris",cn:"瞳孔",d:"你注视某人的时候，时间变慢。你的雨是闭上眼之后视网膜上留下的残像——那是你真正看见过的东西。"}],[{en:"Respiration",cn:"光合",d:"你是清晨推开窗的那个人——干净、透明、不需要多余的解释。你的雨是草叶上的第一滴水珠。"},{en:"Last Word",cn:"明日",d:"你永远在看前方——天还没亮就相信太阳会升起来。你的雨是清晨五点——一种不确定的笃定。"},{en:"Our Melody",cn:"共鸣",d:"你不需说太多——频率对的人自然会听见你。你的雨是两个声音撞在一起变成的第三种声音。"},{en:"Rising Sunset",cn:"潮汐",d:"你知道一切都有节奏——涨和落、来和去，跟随某种更古老的节拍。你的雨是海浪退去后留在沙滩上的泡沫。"},{en:"Past Dream",cn:"旧心事",d:"你不是忘记——你是带着所有发生过的事一起往前走。你的雨是多年没打开的抽屉里一封写了又没寄的信。"},{en:"Prejudice",cn:"我独我",d:"你不需要被人读懂才成立。站在自己的重心上，不被任何风向带偏。你的雨是一个人走在深夜街上，影子被路灯拉得很长。"}],[{en:"Face",cn:"皮囊",d:"你不是伪装——每个版本都是真实的你。你的雨不是面具，是把脸埋进枕头之后剩下的那个自己。"},{en:"Gone",cn:"隐身衣",d:"最好的消失不需要解释——退场者是派对里最有权力的人。你的雨是在别处听见别人提起你的名字。"},{en:"Wait",cn:"等待",d:"等待是你的主动选择——你决定等，所以你在。你的雨是那个人推门进来之前的那一秒。"},{en:"Bliss",cn:"欢愉",d:"快乐来的时候像夏天突如其来的雨——不讲道理，来的时候带着笑声，走的时候甜得很具体。你的雨留在指尖上。"},{en:"Stay",cn:"侍者",d:"你从不需要走在前头——安静地在那里就够了。你的雨是喝完最后一口茶，杯底还有温度的安心。"}],[{en:"Spring",cn:"破土·呼吸",d:"你在最深的土壤里积蓄力量——不声不响，却知道何时破土。你的雨是种子裂开后渗进来的第一口氧气。"},{en:"Summer",cn:"疯长·蔓延",d:"你不计算方向、不控制边界——把所有的力气花在成为自己上。你的雨是热烈本身，不降温、不解释。"},{en:"Autumn",cn:"沉淀·入静",d:"你把一切声音调低，直到听见自己血液流动的频率。你的雨是树木把养分收回根部——不是枯竭，是选择。"},{en:"Winter",cn:"封存·等待",d:"你不行动，你只是保持。你的雨是冻土之下仍然活着的种子——不证明，只是等待。等待也是生长。"}],[{en:"Fall",cn:"自天穹",d:"坠落也是飞翔的一种——是你选择了方向。你的雨落在某片叶子上——轻到没人注意，却足以让叶子轻轻弯下去。"},{en:"Drift",cn:"穿云间",d:"不是所有的雨都急着落地——你选择慢慢来，在云层之间再飘一会儿。你的雨是风吹过云隙时的冰凉自由。"},{en:"Shatter",cn:"碎地霜",d:"碎裂不是终结——是碎成更多个自己，渗入土地成为明天的一部分。你的雨是触地那一瞬间——终于抵达的释然。"}]];document.querySelectorAll(".quiz-opt").forEach(function(b){b.addEventListener("click",function(){var st=parseInt(this.closest(".quiz-step").dataset.step),s=parseInt(this.dataset.s),p=parseInt(this.dataset.p);seriesScores[s]++;productScores[s][p]++;this.parentElement.querySelectorAll(".quiz-opt").forEach(function(x){x.classList.remove("selected")});this.classList.add("selected");setTimeout(function(){var cs=document.querySelector(".quiz-step.active");if(cs)cs.classList.remove("active");if(st<5){var ns=document.querySelector('.quiz-step[data-step="'+(st+1)+'"]');if(ns)ns.classList.add("active")}else{var bestS=0;for(var i=1;i<5;i++)if(seriesScores[i]>seriesScores[bestS])bestS=i;var ps=productScores[bestS],bestP=0;for(var j=1;j<ps.length;j++)if(ps[j]>ps[bestP])bestP=j;var sr=series[bestS],pr=products[bestS][bestP];qrn.innerHTML=sr.cn;qrc.textContent=pr.cn+" · "+pr.en;qrd.innerHTML=pr.d;qr.classList.add("active");var qrProd=document.getElementById("qrProduct");setTimeout(function(){qrProd.classList.add("show")},600)}},280)})});if(qrx)qrx.addEventListener("click",function(){seriesScores.fill(0);productScores.forEach(function(a){a.fill(0)});qr.classList.remove("active");document.getElementById("qrProduct").classList.remove("show");document.querySelectorAll(".quiz-opt").forEach(function(b){b.classList.remove("selected")});document.querySelectorAll(".quiz-step").forEach(function(s){s.classList.remove("active")});qs[0].classList.add("active")});
...
<div class="quiz-step active" data-step="1"><p class="q">闻到雨即将落下时空气里的气味，你会想起——</p><div class="quiz-opts"><button class="quiz-opt" data-s="0" data-p="5">一段走了很久才走到这里的路</button><button class="quiz-opt" data-s="1" data-p="4">某个黄昏天边铺开的颜色</button><button class="quiz-opt" data-s="2" data-p="2">一场从傍晚喝到天亮的酒</button><button class="quiz-opt" data-s="3" data-p="2">一棵老树的叶子从嫩绿到金黄</button><button class="quiz-opt" data-s="4" data-p="0">一滴水从云层坠落到地面的全部过程</button></div></div>
<div class="quiz-step" data-step="2"><p class="q">大雨滂沱时，你最想待在哪里？</p><div class="quiz-opts"><button class="quiz-opt" data-s="0" data-p="3">老图书馆的窗边，玻璃上全是水痕</button><button class="quiz-opt" data-s="1" data-p="3">空旷海岸的悬崖上，看雨打进海里</button><button class="quiz-opt" data-s="2" data-p="3">热闹的酒吧里，雨声被喧哗盖过去</button><button class="quiz-opt" data-s="3" data-p="0">林中小木屋的屋檐下，木头被雨水浸成深色</button><button class="quiz-opt" data-s="4" data-p="2">什么都没有的空房间里，只听见雨打屋顶</button></div></div>
<div class="quiz-step" data-step="3"><p class="q">雨停之后，第一缕光穿过云层。你闻到的是什么？</p><div class="quiz-opts"><button class="quiz-opt" data-s="0" data-p="1">被雨水洗过的青石板路</button><button class="quiz-opt" data-s="1" data-p="0">湿漉漉的草叶和泥土蒸腾的绿意</button><button class="quiz-opt" data-s="2" data-p="4">茶杯里剩下最后一点余温</button><button class="quiz-opt" data-s="3" data-p="1">松针上滴落的雨珠挥发成薄雾</button><button class="quiz-opt" data-s="4" data-p="1">空气里只剩下干净——干净到透明</button></div></div>
<div class="quiz-step" data-step="4"><p class="q">如果把自己比作一场雨，你会是——</p><div class="quiz-opts"><button class="quiz-opt" data-s="0" data-p="6">下了很久很久却越下越安静的夜雨</button><button class="quiz-opt" data-s="1" data-p="5">来势汹涌、去时却留下一道彩虹的急雨</button><button class="quiz-opt" data-s="2" data-p="0">让人措手不及、却被淋得很开心的太阳雨</button><button class="quiz-opt" data-s="3" data-p="3">年年如期而至的季风雨，有固定的节奏</button><button class="quiz-opt" data-s="4" data-p="1">从云层之间穿过的细雨，不急着落地</button></div></div>
<div class="quiz-step" data-step="5"><p class="q">雨带给你最深的感觉是——</p><div class="quiz-opts"><button class="quiz-opt" data-s="0" data-p="4">一种沉静的重量，但你知道它不是负担</button><button class="quiz-opt" data-s="1" data-p="2">万物被洗刷之后的清晰与明亮</button><button class="quiz-opt" data-s="2" data-p="4">不需要理由的快乐，像一场庆典</button><button class="quiz-opt" data-s="3" data-p="3">轮回与重生，一切都按自己的钟表走</button><button class="quiz-opt" data-s="4" data-p="2">一切都安静下来之后的温柔</button></div></div>
