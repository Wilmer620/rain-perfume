...
.hero-gold-line{width:800px;height:.5px;background:var(--gold);margin:1.2rem auto 1.2rem;position:relative;z-index:1;opacity:0;animation:hlReveal 1.4s .75s ease-out forwards}
...
<line x1="138" y1="8"  x2="138" y2="28" stroke="var(--ink)" stroke-width=".7" stroke-linecap="round"/>
