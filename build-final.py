...
/* 日记卡片 */
.diary-motto{font-family:'Noto Serif SC',serif;font-size:.8rem;font-weight:300;color:var(--gold-d);letter-spacing:.08em;line-height:2.2;margin-bottom:2rem;opacity:.65}
...
.diary-date{padding:1rem 1.5rem;font-family:'Inter',sans-serif;font-size:.62rem;letter-spacing:.2em;color:var(--ink2);display:flex;align-items:center;justify-content:space-between;cursor:none}
